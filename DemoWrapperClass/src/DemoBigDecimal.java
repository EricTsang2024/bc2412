...
public class DemoBigDecimal {
  public static void main(String[] args) {
    ...
    System.out.println(0.3 - 0.1); // 0.199999
    ...
    System.out.println(0.1 * 0.2); // 0.0200000000000
    // mutiply
    BigDecimal bd7 = BigDecimal.valueOf(0.1);
    BigDecimal bd8 = BigDecimal.valueOf(0.2);
    BigDecimal bd9 = bd7.multiply(bd8);
    System.out.println(bd9.doubleValue()); // 0.2


    System.out.println(0.3 / 0.1); // 2.99999999999
    // divide
    ...
    System.out.println(bd15.doubleValue()); // 3.0, Non-terminating decimal expension
    ...
    double radius = 4.5;
    double circleArea =
        BigDecimal.valueOf(radius).multiply(BigDecimal.valueOf(radius)) //
    ...
    System.out.println(Math.sqrt(10)); // 3.1622776601683
