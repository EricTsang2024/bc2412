public class Demoif {
  public static void main(String[] args) {
    ...
    // score between 80 and 84, grade for female, grade B
    ...
    if (score >= 90) {
      ...
      grade = 'T'; // else if (score >=87 && score <= 89 && gender == 'M' || score >= 80 && score <= 84 && gender == 'F') {grade = 'T';}
    } else if (score >= 85 && score <= 89 && gender == 'F') {
      grade = 'T';
    } else if (score >= 80 && score <= 84 && gender == 'F') {
      grade = 'B';
    } else if (score >= 80 && score <= 86 && gender == 'M') {
      grade = 'B'; // else if (score >= 80 && score <= 84 && gender == 'F' || score >= 80 && score <= 86 && gender == 'M') {grade = 'C';}
